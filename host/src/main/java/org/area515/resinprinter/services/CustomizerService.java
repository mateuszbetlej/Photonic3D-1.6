...
public class CustomizerService {
	...
	public void projectCureLayerImage(@PathParam("customizerName") String customizerName) throws SliceHandlingException, InappropriateDeviceException, NoPrinterFoundException {
		...
		try {
			...
			try {
				Process showingSlice = Runtime.getRuntime().exec(new String[]{"nice", "-n", "-2", "/home/pi/raspidmx/demo_mask_overlay_with_args/show_image", "-d", "5", "-t", "10", "-p", printerName, "-e", "10000", "-b", "5", "-x", "50000", "-m", "/home/pi/mask/mask.png", "/tmp/printdir/display_cure_to_be_hidden.zip/display_cure_to_be_hidden.png"});
